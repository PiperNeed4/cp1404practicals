...
class ProgrammingLanguage:
    ...
    def __init__(self, name, typing, reflection, year, pointer_arithmetic=False):
        ...
        self.year = year
        self.pointer_arithmatic = pointer_arithmetic

    def __repr__(self):
        """Return string representation of a ProgrammingLanguage."""
        return (f"{self.name}, {self.typing} Typing, Reflection={self.reflection}, First appeared in {self.year}, Pointer arithmatic="
                f"{self.pointer_arithmatic}")
